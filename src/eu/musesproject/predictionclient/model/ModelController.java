...
import eu.musesproject.predictionclient.builder.FeatureVectorBuilder;
...
import eu.musesproject.predictionclient.ui.LabelDialog;
...
public class ModelController {
	...
	public void buildModel(Context context) {
		...
		if (checkChargingStatus(context)) {
			...
			// get feature vector
			mFeatureVector = mFeatureVectorBuilder.createFeatureVector(allAppNames);

			// create training set
			Instances trainingSet = mTrainingSetBuilder.createTrainingSet(context, dbManager, mFeatureVector,
			...
			if (mClassifier != null) {
				try {
					...
					IsClassificationActivatedPreference.getInstance(context).set(true);
	...
	public Classifier getClassifier(Context context) {
		if (mClassifier == null && IsModelCreatedPreference.getInstance().get(context)) {
			mClassifier = ClassifierSerializer.deserializeClassifier(ClassifierSerializer
	...
	public static class MODEL_DATA {
		...
		public static final String BLUETOOTH_TRUE = BluetoothState.TRUE.toString();
		public static final String BLUETOOTH_FALSE = BluetoothState.FALSE.toString();
		public static final String BLUETOOTH_NOT_SUPPORTED = BluetoothState.NOT_SUPPORTED.toString();
		...
		public static final String PACKAGE_STATUS_INSTALLED = PackageStatus.INSTALLED.toString();
		public static final String PACKAGE_STATUS_REMOVED = PackageStatus.REMOVED.toString();
		public static final String PACKAGE_STATUS_UPDATED = PackageStatus.UPDATED.toString();
