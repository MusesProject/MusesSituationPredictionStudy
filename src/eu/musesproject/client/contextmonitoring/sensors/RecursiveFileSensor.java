...
//        rootPathToObserve = "/Pictures/";
     ...
     * {@link eu.musesproject.client.contextmonitoring.sensors.RecursiveFileSensor#createContextEvent(String, String)}
     */
    @Override
    public void enable() {
        if(!running){
     ...
     * @param eventText private static field of {@link eu.musesproject.client.contextmonitoring.sensors.RecursiveFileSensor} that describes the event.
