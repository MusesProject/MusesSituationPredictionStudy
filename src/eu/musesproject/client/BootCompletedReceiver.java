...
public class BootCompletedReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent arg1) {
		...
		if (IsLabelingActivatedPreference.getInstance().get(context) || IsModelCreatedPreference.getInstance().get(context) || IsWaitingForModelBuildPreference.getInstance().get(context)  || IsClassificationActivatedPreference.getInstance().get(context)) {
